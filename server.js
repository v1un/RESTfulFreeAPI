...
// Restante das importações (Express, etc.) DEPOIS do dotenv.config()
const express = require('express');
const cors = require('cors');
const helmet = require('helmet'); // <-- CORRIGIDO: Linha descomentada/presente
...
app.use(helmet()); // <-- AGORA DEVE FUNCIONAR
